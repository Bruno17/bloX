...
$bloxconfig['cacheElementKey'] = $modx->getOption('cacheElementKey', $scriptProperties, $modx->resource->getCacheKey() . '/' . md5($modx->toJSON($scriptProperties) . $modx->toJSON($modx->request->getParameters())));
